...
function(a){return{"<":"&lt;",">":"&gt;"}[a]})}function m(a){var c=a.msg,d=firebase.database().ref("/users/"+a.from);a.msg=r(a.msg);a.msg=a.msg.replace(/[-a-zA-Z0-9@:%_\+.~#?&/=]{2,256}\.[a-z]{2,4}\b(\/[-a-zA-Z0-9@:%_\+.~#?&//=]*)?/gi,function(a){var b=document.createElement("a");a.startsWith("http://")||a.startsWith("https://")?b.href=a:b.href="//"+a;b.innerHTML=a;b.target="_blank";return b.outerHTML});a.msg=a.msg.replace(/\b_(\S[\s\S]*?)_\b/gi,function(a,c){var b=document.createElement("em");b.innerHTML=
c;return b.outerHTML});a.msg=a.msg.replace(/\*\b(\S[\s\S]*?)\b\*/gi,function(a,c){var b=document.createElement("strong");b.innerHTML=c;return b.outerHTML});return d.once("value").then(function(b){b=b.val();return{name:b.username,msg:a.msg,user:b,data:a,raw:c}}).then(function(a){var b=Number(a.data.timestamp)>Number(tchat.loadedTime);!document.hasFocus()&&!0===tchat.notifs&&b&&navigator.serviceWorker.ready.then(function(b){b.showNotification(a.name||"New message",{body:c,icon:a.user.photo,badge:"https://benji.pw/assets/icons/t.png",
